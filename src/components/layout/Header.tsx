...
export const Header = () => {
  ...
  return (
    <header className={`fixed top-0 z-50 w-full transition-all duration-300 ${isHome ? "bg-transparent py-4" : "bg-background/80 backdrop-blur-md border-b border-surface-hover py-3"} px-6 flex items-center justify-between`}>
      ...
      {/* Left: Logo */}
      <Link href="/" className="flex items-center gap-2 group translate-x-[-167px]">
        <div className="h-[20.4px] transition-transform group-hover:scale-105 translate-y-[0px] translate-x-[20px] ml-[142px]">
          <img 
        ...
        <span className="font-bold text-xl tracking-tight text-foreground ml-[10px]">NexTrip</span>
      </Link>
